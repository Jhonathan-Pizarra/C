...
int main(){
    ...
    /*
     * Tenga en cuenta que el especificador de formato incluye 4.2 para indicar que el flotante
     * se imprimirá en un espacio de al menos 4 caracteres de ancho con 2 decimales.
